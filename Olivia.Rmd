...
frog <- fieldscale %>% select(ID, YEAR, SITE, FSIZE, HRBF, HRBL, INSE.A, FROGR, PLPHY, HYLA, TADPL, EFFRG, EFTRP) %>% subset(fieldscale$FROGR>=0) %>% subset(fieldscale$HRBF>=0)
...
plot(frog$FROGR, frog$INSE.A, main = 'Frog Abundance vs Insecticide Use in Nursery Boxes', xlab = 'Frog Abundance', ylab = 'Insecticide Use', pch = 19, frame = FALSE)
...
plot(frog$PLPHY, frog$INSE.A, main = 'Pelophylax Abundance vs Insecticide Use in Nursery Boxes', xlab = 'Pelophylax Abundance', ylab = 'Insecticide Use', pch = 19, frame = FALSE)
...
plot(frog$HYLA, frog$INSE.A, main = 'H. Japonica Abundance vs Insecticide Use in Nursery Boxes', xlab = 'H. Japonica Abundance', ylab = 'Insecticide Use', pch = 19, frame = FALSE)
...
plot(tadpole$TAPL, tadpole$INSE.A, main = 'Tadpole Abundance vs Insecticide Use in Nursery Boxes', xlab = 'Tadpole Abundance', ylab = 'Insecticide Use', pch = 19, frame = FALSE)
```
